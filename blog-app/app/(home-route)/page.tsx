    ...
    <>
      <section className="bg-white dark:bg-gray-900">
        <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
          ...
          <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Aplikasi Wirausaha Lengkap Kelola
            Bisnis Landry Jadi Maju</h1>
          <p className="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">Aplikasi laundry adalah software yang di khususkan bagi pengusaha laundry untuk membantu mengatur manajemen mulai dari : Transaksi laundry, record data pelanggan laundry, record data order laundry, cetak nota laundry, kirim nota via Whatsapp, laporan keuangan dan keuntungan laundry, laporan pengeluaran laundry, tambah cabang laundry dan fitur lainnya</p>
      ...
      <section className="bg-teal-50 dark:bg-gray-900">
        <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div className="mr-auto place-self-center lg:col-span-7">
            <h1 className="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white">MITUNI Laundry</h1>
      ...
      <section className="bg-white dark:bg-gray-900">
        <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
          <div className="max-w-screen-md mb-8 lg:mb-16">
            <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Feature</h2>
            <p className="text-gray-500 sm:text-xl dark:text-gray-400">Mudah Digunakan</p>
          </div>
          <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
            <div>
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Mudah Digunakan</h3>
              <p className="text-gray-500 dark:text-gray-400">Tampilan dengan ikon yang sangat mudah dikenali dan digunakan untuk awam sekalipun</p>
            </div>
            <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Terdapat Versi Gratis Selamanya</h3>
              <p className="text-gray-500 dark:text-gray-400">Nikmati versi gratis selamanya tetapi terdapat batasan transaksi perhari</p>
            </div>
            <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Backup Online</h3>
              <p className="text-gray-500 dark:text-gray-400">Tidak perlu takut data anda hilang ketika aplikasi dihapus, karena tersimpan di server kami</p>
            </div>
            <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Fitur Lengkap</h3>
              <p className="text-gray-500 dark:text-gray-400">Fitur lengkap untuk mengelola bisnis laundry anda, mulai dari transaksi, customer, pengeluaran, hingga laporan omset dan pemasukan</p>
            </div>
            <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">CS 24 jam</h3>
              <p className="text-gray-500 dark:text-gray-400">Customer service yang siap membantu anda 24 jam /7 har</p>
            </div>
            <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Gratis Update</h3>
              <p className="text-gray-500 dark:text-gray-400">Kami akan selalu memperbaharui fitur aplikasi menjadi lebih baik dan anda akan mendapatkan update fitur terbaru setiap kami update aplikasi secara gratis</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-teal-50 dark:bg-gray-900">
        <div className="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
          ...
          <div className="mt-4 md:mt-0">
            <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Dengan fitur unggulan untuk usaha laundry anda</h2>
          ...
          <div className="grid mb-8 lg:mb-12 lg:grid-cols-2">
            <figure className="flex flex-col justify-center items-center p-8 text-center bg-gray-50 border-b border-gray-200 md:p-12 lg:border-r dark:bg-gray-800 dark:border-gray-700">
              <blockquote className="mx-auto mb-8 max-w-2xl text-gray-500 dark:text-gray-400">
                ...
                <p className="my-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Beatae quam dolorum cum. Sit quos molestias labore magni. Repellendus aspernatur, culpa recusandae quisquam nemo placeat exercitationem ad modi? Quaerat, minus quisquam.</p>
            ...
            <figure className="flex flex-col justify-center items-center p-8 text-center bg-gray-50 border-b border-gray-200 lg:border-b-0 md:p-12 lg:border-r dark:bg-gray-800 dark:border-gray-700">
              <blockquote className="mx-auto mb-8 max-w-2xl text-gray-500 dark:text-gray-400">
                ...
                <p className="my-4">Everything is so well structured and simple to use ve learnt so much about Figma by just using the toolkit</p>
    ...
    <div className="grid pt-8 text-left border-t border-gray-200 md:gap-16 dark:border-gray-700 md:grid-cols-2">
      <div>
        ...
        <div className="mb-10">
          ...
          <p className="text-gray-500 dark:text-gray-400"> aware of the importance of well qualified support, that is why we decided that support will only be provided by the authors that actually worked on this project.</p>
          <p className="text-gray-500 dark:text-gray-400">Feel free to <a href="#" className="font-medium underline text-primary-600 dark:text-primary-500 hover:no-underline" target="_blank" rel="noreferrer">contact us</a> and  help you out as soon as we can.</p>
        </div>
        <div className="mb-10">
          <h3 className="flex items-center mb-4 text-lg font-medium text-gray-900 dark:text-white">
            <svg className="flex-shrink-0 mr-2 w-5 h-5 text-gray-500 dark:text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-8-3a1 1 0 00-.867.5 1 1 0 11-1.731-1A3 3 0 0113 8a3.001 3.001 0 01-2 2.83V11a1 1 0 11-2 0v-1a1 1 0 011-1 1 1 0 100-2zm0 8a1 1 0 100-2 1 1 0 000 2z" clipRule="evenodd" /></svg>
          ...
          <p className="text-gray-500 dark:text-gray-400">You can use Windster for an unlimited amount of projects, whether  a personal website, a SaaS app, or a website for a client. As long as you  build a product that will directly compete with Windster either as a UI kit, theme, or template.</p>
