...
const Navbar = () => {
    return (
        <header className='border-b sticky backdrop-blur-lg bg-white/75 top-0 z-50'>
            <nav>
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    <a href="https://flowbite.com/" className="flex items-center">
                        <img src="assets/img/logo/logo.png" className="h-8 mr-3" alt="Flowbite Logo" />
                        <span className="self-center text-2xl font-bold whitespace-nowrap">Flowbite</span>
                    </a>
                    ...
                    <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-cta">
                        <ul className="flex flex-col  ">
                            <li>
                                <Button className="block  pr-4">Home</Button>
                            </li>
                        </ul>
                    </div>
                </div>
